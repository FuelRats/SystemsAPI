...
def upgrade():
    ...
    op.create_foreign_key('fk_bodies_systemId64_systems', 'bodies', 'systems', ['systemId64'], ['id64'])
    op.create_foreign_key('fk_stars_systemId64_systems', 'stars', 'systems', ['systemId64'], ['id64'])
    op.create_foreign_key('fk_stations_systemId64_systems', 'stations', 'systems', ['systemId64'], ['id64'])
    ...
    op.create_index('system_idx_name_gin', 'systems', ['name'], unique=False, postgresql_using='gin',
                    postgresql_ops={'name': 'gin_trgm_ops'})
    op.create_index('system_idx_name_soundex', 'systems', ['name'], unique=False, postgresql_using='btree',
                    postgres_ops={'name': 'soundex'})
    op.create_index('system_idx_name_dmetaphone', 'systems', ['name'], unique=False, postgresql_using='btree',
                    postgres_ops={'name': 'dmetaphone'})
...
def downgrade():
    ...
    op.drop_index('system_idx_name_dmetaphone', table_name='systems')
